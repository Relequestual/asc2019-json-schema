...
import { schemaFiles } from "./schemas/basic/index.js";
console.log(schemaFiles);
const schemaString = _.mapValues(schemaFiles, (schema) => JSON.stringify(schema.default, null, 2));
